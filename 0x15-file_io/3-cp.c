...
/**
 * from_to - Read from and write to copy to
 *
 * @cpy: Struct
 *
 */
...
/**
 * file_copy - Copy one file to another
 *
 * @cpy: Struct
 *
 */
...
/**
 * init_struct - Initialize copy struct
 *
 * @cpy: Struct
 * @argv: Argument to put into struct
 *
 */
